...
form.addEventListener("submit", (e) => {
  ...
  localStorage.setItem("temp-city", city.value);
  localStorage.setItem("temp-year", year.value);

  // function: use city.value to get city ID
    ...
    $.ajax({
      ...
      .then(function (tempData) {
        ...
        for (let i = 0; i < tempData.length; i++) {
          let tr = "<tr>";
          tr += "<td>" + tempData[i].date + "</td>" + "<td>" + tempData[i].value + "</td></tr>";
          tbody.innerHTML += tr;
        }
